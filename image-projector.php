...
function wpiv_load_script()
{
		...
		|| (is_archive() && $add_archive == '1')))
	{
		...
		$localfile 			= THIS_PLUGIN_DIR."/ref/wpiv_ref_1_3.js";
		$localfilecaption 	= THIS_PLUGIN_DIR."/ref/wpiv_ref_c_1_3.json";
	...
	wp_register_script( 'wpiv_reference', THIS_PLUGIN_URL.'/ref/wpiv_ref_1_3.js',array(),THIS_VERSION);
...
function wpiv_generate_postimage_reference_js() {
	...
	$jsFile = $refDir."/wpiv_ref_1_3.js";
	$handle = fopen($jsFile,"w");
	//caption
	if($doCaption) {
		$jsonFile =  $refDir."/wpiv_ref_c_1_3.json";
