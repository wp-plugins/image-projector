=== Image Projector ===
Contributors: wpgloe
Tags: photography, photo, image, viewer, slide, show, gallery, simple, image in post
Tested up to: 4.2.2
...
You can see it in use in a single post page [here](http://www.lystfotograf.net/archives/2446 "A single post page on lystfotograf.net") or from an archive page [here](http://www.lystfotograf.net/tags/fog "A tag archive page on lystfotograf.net"). Click an image.
